  ...
  return (
    <>
      <div className="min-h-screen flex flex-col">
        <div className="drawer lg:drawer-open items-start flex-1">
        {/* Drawer Toggle */}
        <input id="my-drawer-2" type="checkbox" className="drawer-toggle" />
        <div className="drawer-content flex flex-col items-center justify-center">
            {/* Buttons container */}
            <div className="w-full flex justify-between items-center px-4 mt-5">
              {/* Filtri button */}
          <label
            htmlFor="my-drawer-2"
                className="btn bg-zinc-800 hover:bg-zinc-700 text-white border-none drawer-button lg:hidden"
          >
            ...
            {/* Lista Prodotti o Messaggio "Nessun prodotto trovato" */}
            ...
            />
                ...
                <div className="text-center py-20">
                  <h3 className="text-2xl font-bold text-zinc-400 mb-2">Nessun prodotto trovato</h3>
