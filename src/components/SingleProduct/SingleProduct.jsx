        ...
        <div className="main-content">
          ...
          <div className="mobile-order-container">
              ...
              <div className="product-image-section">
                ...
                <button 
                  ...
                  onClick={() => {
                    ...
                    dispatch(setSelectedProduct(prevProduct));
                  }}
                >
                  ...
                  <div className="product-image-wrapper">
                    <div
                      ...
                      style={{
                        ...
                        backgroundSize: !isMobile && isHovering
                          ? `${width * zoom}px ${height * zoom}px`
                          : 'contain',
                        backgroundPosition: !isMobile && isHovering
                ...
                <button 
                  ...
                  onClick={() => {
                    ...
                    dispatch(setSelectedProduct(nextProduct));
                  }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="cart-heading-mobile">
              <div className="flex items-center justify-between bg-zinc-800 p-4 rounded-lg shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
